 ...
 *
 */
public class GenLoadScript_2d_a {
	...
	public static void main(String[] args) throws Throwable {
		...
		FileOutputStream fox = new FileOutputStream( "runLoad_2d_a.sh" );
		...
		psx.println( "");
		psx.println( "#");
		psx.println( "# Tests the ability to load Pickle files of a 2-D TensorFlow neural-net model for slope estimation and perform some basic manipulations.");
		psx.println( "# Generated by GenLoadScript_2d_a.java.  Do not directly modify this file.  Instead, modify the GenLoadScript_2d_a.java file that produced it.");
		...
		for( int t = 0 ; t < MAX_T ; t++ )
		{
			...
			psx.println( "python3 load_2d_a.py yvals_" + t + "_" + x + "_.txt wvals_" + t + "_" + x + "_.pkl bvals_" + t + "_" + x + "_.pkl"  );
		}
