 ...
 *
 */
public class GenTrainScript_2d_a {
	...
	public static void main(String[] args) throws Throwable {
		...
		FileOutputStream fox = new FileOutputStream( "runTrain_2d_a.sh" );
		...
		psx.println( "");
		psx.println( "#");
		psx.println( "# Tests the ability to train a 2-D TensorFlow neural-net model for slope estimation and write the results to Pickle files.");
		psx.println( "# Generated by GenTrainScript_2d_a.java.  Do not directly modify this file.  Instead, modify the GenTrainScript_2d_a.java file that produced it.");
		psx.println( "# Note: the xvals and yvals files used by this script are not checked-in, but are instead generated by GenEstimationTests_2d_a.java");
		...
		for( int t = 0 ; t < MAX_T ; t++ )
		{
			...
			psx.println( "python3 train_2d_a.py yvals_" + t + "_" + x + "_.txt wvals_" + t + "_" + x + "_.pkl bvals_" + t + "_" + x + "_.pkl"  );
		}
