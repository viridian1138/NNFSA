 ...
 *
 */
public class GenExportScript_3d_a {
	...
	public static void main(String[] args) throws Throwable {
		...
		FileOutputStream fox = new FileOutputStream( "runExport_3d_a.sh" );
		...
		psx.println( "");
		psx.println( "#");
		psx.println( "# Tests the ability to export Pickle files of a TensorFlow neural-net model for 3-D slope estimation to text files that can be read from Java.");
		psx.println( "# Generated by GenExportScript_3d_a.java.  Do not directly modify this file.  Instead, modify the GenExportScript_3d_a.java file that produced it.");
		...
		for( int t = 0 ; t < MAX_T ; t++ )
		{
			...
			psx.println( "python3 export_a.py wvals_" + t + "_" + x + "_" + y + "_.pkl bvals_" + t + "_" + x + "_" + y + "_.pkl wvals_txt_" + t + "_" + x + "_" + y + "_.txt bvals_txt_" + t + "_" + x + "_" + y + "_.txt"  );
		}
